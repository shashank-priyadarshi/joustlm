	...
	tests := []struct {
	...
	}{
		{
			...
			analysis: &db.Analysis{
				...
				Topics:     "technology,analysis,data",
				Sentiment:  "neutral",
		...
		},
		{
			...
			analysis: &db.Analysis{
				...
				Sentiment:  "positive",
				Keywords:   "intelligence,algorithms,learning",
				Confidence: 0.92,
			},
			expectError: false,
		},
	...
	tests := []struct {
	...
	}{
		{
			...
			setupAnalysis: &db.Analysis{
				...
				Topics:     "testing,retrieval,analysis",
				Sentiment:  "neutral",
				Keywords:   "test,analysis,retrieval",
				Confidence: 0.75,
			},
			expectError: false,
			expectFound: true,
		...
		suite.Run(tt.name, func() {
			for i := 0; i < tt.analysesToCreate; i++ {
				analysis := &db.Analysis{
					...
					Topics:     "testing,analysis,pagination",
					Sentiment:  "neutral",
					Keywords:   "analysis,test,data",
					Confidence: 0.8,
				}
	...
	tests := []struct {
	...
	}{
		{
			...
			setupAnalysis: &db.Analysis{
				...
				Topics:     "original,topic,analysis",
				Sentiment:  "neutral",
				Keywords:   "original,keyword,test",
				Confidence: 0.7,
			},
			updates: &db.Analysis{
				Title:      "Updated Title",
				Summary:    "Updated summary with more detailed information.",
				Topics:     "updated,enhanced,analysis",
				Sentiment:  "positive",
				Keywords:   "updated,enhanced,data",
				Confidence: 0.9,
			},
			expectError: false,
		},
	...
	tests := []struct {
	...
	}{
		{
			...
			setupAnalysis: &db.Analysis{
				...
				Topics:     "deletion,testing,analysis",
				Sentiment:  "neutral",
				Keywords:   "delete,test,analysis",
				Confidence: 0.6,
			},
			expectError: false,
		},
...
func (suite *DaoTestSuite) TestSearchAnalyses() {
	tests := []struct {
	...
	}{
		{
			...
			userID: uuid.MustParse("00000000-0000-0000-0000-000000000000"), // Use a fixed UUID to avoid conflicts
			analysesToCreate: []*db.Analysis{
				{
					ID:         uuid.New(),
					UserID:     uuid.New(),
					...
					Topics:     "artificial intelligence,technology,future",
					Sentiment:  "neutral",
					Keywords:   "intelligence,learning,technology",
					Confidence: 0.9,
				},
				{
					ID:         uuid.New(),
		...
		},
		{
			...
			userID: uuid.MustParse("11111111-1111-1111-1111-111111111111"), // Use a fixed UUID to avoid conflicts
			analysesToCreate: []*db.Analysis{
				{
					ID:         uuid.New(),
					UserID:     uuid.New(), // This will be overridden by the test setup
					Text:       "This is a positive review of the product.",
					Title:      "Positive Review",
					Summary:    "Great product with excellent features.",
					Topics:     "review,product,quality",
					Sentiment:  "positive",
				...
				},
				{
					...
					Topics:     "review,service,issues",
					Sentiment:  "negative",
					Keywords:   "review,service,issues",
					Confidence: 0.75,
				},
			},
			topic:         "",
